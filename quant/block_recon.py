    ...
    for module in block.modules():
        if isinstance(module, QuantModule):
            if module.weight_quantizer.lwc:
                alpha_params += [module.weight_quantizer.alpha]
                bounds_params += [module.weight_quantizer.upbound_factor, module.weight_quantizer.lowbound_factor]
                # module.weight_quantizer.lwc_train = True
            else:
                alpha_params += [module.weight_quantizer.alpha]
